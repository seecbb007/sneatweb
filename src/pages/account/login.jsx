      ...
      <Box sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          <Grid
            ...
            minWidth={"25rem"}
          >
            <div className="information" style={{ marginTop: "3rem" }}>
              <div className="inforContainer">
                <div className="webTitleContainer">
                  <img src={logo} className="webLogo"></img>
                  <span className="web_Title">sneat</span>
                </div>
                <div className="login_Title">Welcome to Sneat! 👋🏻</div>
                <div className="login_subTitle">
                  Please sign-in to your account and start the <br></br>{" "}
                  adventure
                </div>
                <div className="passwordTips">
                  <div className="accountCredentials">
                    Admin:
                    <strong className="account">admin@sneat.com</strong> /
                    Password:
                    <strong className="account"> Adminadmin</strong>
                  </div>
                  <div className="accountCredentials">
                    Client:
                    <strong className="account">client@sneat.com</strong> /
                    Password:
                    <strong className="account"> Clientclient</strong>
                  </div>
                </div>
                    ...
                    {/* {user.password.length < 5 && user.password !== "" ? (
                      <FormControl sx={{ m: 1 }} variant="outlined" fullWidth>
                        ...
                        <OutlinedInput
                          ...
                          label="Password"
                          helperText="Password must be at least 5 characters"
                        />
                        <Typography
                          sx={{
                            fontSize: "0.8rem",
